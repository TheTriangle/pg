...
class CircleUnit : public Unit
    ...
    void Shoot(HDC bulletimage, double imgwidth, double imgheight, double grad, double sspeed, double gdamage, double angle)
        {
        POINT helpcords = this->getCUnitCords();
        Bullet helpbullet (bulletimage, imgwidth, imgheight, helpcords.x, helpcords.y, grad, angle, sspeed, 9999, gdamage, id);
